/* This file contains references to the vendor livraries
...
as the application's code. s all the libraies we reference
here will be writen to vendor.hs so they can be
